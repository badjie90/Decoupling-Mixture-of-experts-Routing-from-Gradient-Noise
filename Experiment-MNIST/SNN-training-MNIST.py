...
IN_FEAT = "outputs/mnist_features/features.npy"
IN_LABEL = "outputs/mnist_features/labels.npy"
IN_SPLIT = "outputs/mnist_split/labeled_idx.npy"
OUT_DIR = "outputs/mnist_siamese"
