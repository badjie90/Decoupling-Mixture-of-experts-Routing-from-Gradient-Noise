...
"""
Step 1: Feature Extraction with Frozen EfficientNet-B1 on GTSRB

Outputs:
- features.npy  -> shape [N, 1280]
- labels.npy    -> shape [N]
...
# -------------------------------
DATA_ROOT = "./data"
OUTPUT_DIR = "./outputs/gtsrb_features"
BATCH_SIZE = 64
NUM_WORKERS = 4
...
# -------------------------------
transform = T.Compose([
    T.Resize((240, 240)),  # EfficientNet-B1 default
    T.ToTensor(),
    T.Normalize(
