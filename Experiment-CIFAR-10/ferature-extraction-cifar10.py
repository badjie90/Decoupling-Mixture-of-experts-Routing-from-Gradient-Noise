...
"""
Step 1: Feature Extraction with Frozen EfficientNet-B1 on CIFAR-10

Outputs:
- features.npy  -> shape [60000, 1280]
- labels.npy    -> shape [60000]
...
# -------------------------------
DATA_ROOT = "./data"
OUTPUT_DIR = "./outputs/cifar10_features"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
# -------------------------------
transform = T.Compose([
    T.Resize((240, 240)),  # EfficientNet-B1 input resolution
    T.ToTensor(),
    T.Normalize(
